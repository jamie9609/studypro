...
/**
 * 参考资料：https://developers.google.cn/optimization/routing/tsp
 * @PackageName: com.algorithm.tsp
 * @ClassName: ortools
 * @Description:
 * @Author: jamiezhangming
 * @Date: 2021/12/14 5:33 下午
 */
public class OrtoolsDemo {
    private static final Logger logger = Logger.getLogger(OrtoolsDemo.class.getName());
